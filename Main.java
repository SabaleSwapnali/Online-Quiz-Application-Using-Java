/*The application is a simple console based application and it is going to display some question to the user
  ...
  class Quiz
  {
      void begin()
      {
          ...
          questions[0] = new Question("Who is known as the father of C programming language?","Dennis Ritchie","James Gosling","Guido van Rossum ","Sir Timothy John Berners-Lee", new Answer("Dennis Ritchie"));
          questions[1] = new Question("Is a C Language is  compiled or interpreted?","Compiled","Interpreted","Both","None", new Answer("Compiled"));
          questions[2] = new Question("Which of the following is not Programming Language ?","Python","Java","HTML","C++", new Answer("HTML"));
          questions[3] = new Question("Who is known as the father of JAVA programming language?","Dennis Ritchie","James Gosling","Guido van Rossum ","Bjarne Stroustrup ", new Answer("James Gosling"));
          questions[4] = new Question("When was Java developed?","1991","1995","1990","1998", new Answer("1995"));
